...
export default async function AccountPage() {
  ...
  return <AccountDashboard initialName={user.displayName} initialEmail={user.email} initialIsAdmin={adminEmails().has(user.email.toLowerCase())} logoutHref={authSignOutPath(user.provider)} authProvider={user.provider} />;
}

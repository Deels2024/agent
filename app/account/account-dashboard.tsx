...
export default function AccountDashboard({ initialName, initialEmail, initialIsAdmin, logoutHref, authProvider }: { initialName: string; initialEmail: string; initialIsAdmin: boolean; logoutHref: string; authProvider: "chatgpt" | "standalone" }) {

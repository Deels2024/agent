      ...
      <div className="account-content">
        ...
        {section === "marketplaces" && <section className="account-section">
          ...
          <section className="account-marketplace-hero">
            <div className="account-marketplace-brand"><span>O</span><div><small>Первое подключение</small><h2>Ozon</h2><p>Вход выполняется только на официальной странице Ozon.</p></div></div>

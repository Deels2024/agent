  ...
  return <main className="auth-page">
    ...
    <section className="auth-shell">
      <div className="auth-benefits">
        ...
        <h1>{mode === "register" && roleIntent === "seller" ? "Новые покупатели для вашего магазина" : "Выгодные покупки под вашим контролем"}</h1>
        <p>{mode === "register" && roleIntent === "seller" ? "Добавляйте ассортимент, получайте подходящий спрос и предлагайте цену лучше маркетплейсов." : "История поиска, контроль цены, предложения магазинов, заказы и помощь после покупки — в одном месте."}</p>
        {mode === "register" && roleIntent === "seller"
